...
class GalleryController extends Controller
{
    ...
    public function insert_gallery(GalleryRequest $request,$pro_id){ 
            ...
            foreach ($gallery as $key => $gal) {
                ...
                <tr>
                 <td>'.$i.'</td>
                  ...
                  <td>
                <img src="'.url('/uploads/gallery/'.$gal->gallery_image).'" class="img-thumbnail" height="120px" width="120px">
                <input type="file" class="file_image" style="width:40%" data-gal_id ="'.$gal->gallery_id.'" id="file-'.$gal->gallery_id.'"
                 name="file" accept="image/*0" >
                  </td>
