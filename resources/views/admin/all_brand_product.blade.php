          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  ...
                  <a onclick="return confirm('Bạn chắc là xoá chứ ?')" href="{{ URL::to('/delete-brand-product/'.$brand_pro->brand_id) }}" class="active styling-edit" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
